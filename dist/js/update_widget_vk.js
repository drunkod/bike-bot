const access_token = process.env.VK_TOKEN_WIDGET_OVER;
const admin_id = process.env.VK_ADMIN_ID;
const admin_fullname = process.env.VK_ADMIN_FULLNAME;
...
module.exports = class update_widget_vk extends fireBase {
  ...
  static async appWidgetsUpdate(
    ...
    let rows_array = arr
      ...
      .join();
    //update app widget
    // обновление виджета не чаще 1 раза в 10 сек
